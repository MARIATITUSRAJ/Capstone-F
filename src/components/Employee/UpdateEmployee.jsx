...
const UpdateEmployee = () => {
    ...
    useEffect(() => {
        axios.get('https://hr-management-system-zl57.onrender.com/employee/' + id)
            .then(result => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://hr-management-system-zl57.onrender.com/edit_employee/' + id, updatedEmployee)
            .then(result => {
